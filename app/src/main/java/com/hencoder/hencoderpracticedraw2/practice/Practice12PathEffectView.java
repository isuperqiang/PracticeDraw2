...
public class Practice12PathEffectView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // 第三处：DashPathEffect
        PathEffect dashPathEffect = new DashPathEffect(new float[]{20, 10, 5, 20}, 0);
        ...
        dashPath.close();
        PathEffect pathDashPathEffect = new PathDashPathEffect(dashPath, 50, 0, PathDashPathEffect.Style.TRANSLATE);
